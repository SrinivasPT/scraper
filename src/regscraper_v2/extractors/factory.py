...
from ..interfaces import TextExtractor, ContentType
from .implementations import PdfTextExtractor, DocxTextExtractor, HtmlTextExtractor
...
class ExtractorFactory:
    ...
    def _detect_content_type(self, url: str, content_type: str) -> ContentType:
        ...
        elif any(indicator in url_lower for indicator in [".rss", "/feed", "/rss"]):
        ...
        if content_type:
            ...
            if "pdf" in content_type_lower:
                ...
                doc_type in content_type_lower
                for doc_type in ["msword", "wordprocessingml"]
            ):
                return ContentType.DOCX
            elif any(
                rss_type in content_type_lower for rss_type in ["rss", "xml", "atom"]
            ):
                return ContentType.RSS
    ...
    def register_extractor(
        self, content_type: ContentType, extractor: TextExtractor
    ) -> None:
